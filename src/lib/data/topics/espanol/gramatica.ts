      ...
      questions: [
        {
          ...
          options: [
            {
              es: "El grande y hermoso campo verde",
              en: "The big and beautiful green field",
            },
            {
              es: "Los estudiantes aprobaron el examen",
              en: "The students passed the exam",
            },
            {
              es: "Debajo de la mesa del comedor",
              en: "Under the dining table",
            },
            {
              es: "Rápidamente, con mucha precaución",
              en: "Quickly, with much caution",
            },
          ],
          correctAnswer: "1",
          explanation: {
        ...
        },
        {
          ...
          options: [
            ...
            {
              es: "María estudia y su hermano trabaja",
              en: "Maria studies and her brother works",
            },
            {
        ...
        },
        {
          ...
          options: [
            {
              es: "Iré al cine y después cenaré",
              en: "I'll go to the movies and then have dinner",
            },
            {
              es: "Quería ir, pero no pudo",
              en: "He wanted to go, but couldn't",
            },
            {
              es: "O vienes conmigo o te quedas",
              en: "Either you come with me or you stay",
            },
            {
              es: "Estudia porque mañana tiene examen",
              en: "Study because tomorrow you have an exam",
            },
          ],
          correctAnswer: "1",
          explanation: {
        ...
        },
        {
          ...
          options: [
            {
              es: "Si llueve, no iremos al parque",
              en: "If it rains, we won't go to the park",
            },
            {
              es: "Llegó tarde porque había mucho tráfico",
              en: "He arrived late because there was a lot of traffic",
            },
            {
              es: "Cuando termine, te aviso",
              en: "When I finish, I'll let you know",
            },
            {
              es: "El libro que leíste es interesante",
              en: "The book you read is interesting",
            },
          ],
          correctAnswer: "1",
          explanation: {
      ...
      questions: [
        {
          ...
          options: [
            ...
            {
              es: "Los alumnos de tercer grado",
              en: "The third grade students",
            },
        ...
        },
        {
          ...
          options: [
            {
              es: "Un sujeto que aparece al inicio de la oración",
              en: "A subject that appears at the beginning of the sentence",
            },
            {
              es: "Un sujeto que no se menciona explícitamente pero se deduce del verbo",
              en: "A subject that is not explicitly mentioned but is deduced from the verb",
            },
            {
              es: "Un sujeto que es un pronombre",
              en: "A subject that is a pronoun",
            },
            {
              es: "Un sujeto que es un nombre propio",
              en: "A subject that is a proper noun",
            },
          ],
          correctAnswer: "1",
          explanation: {
        ...
        },
        {
          ...
          options: [
            {
              es: "Oración con sujeto tácito",
              en: "Sentence with tacit subject",
            },
            {
              es: "Oración impersonal (sin sujeto)",
              en: "Impersonal sentence (without subject)",
            },
            {
              es: "Oración con sujeto compuesto",
              en: "Sentence with compound subject",
            },
        ...
        },
        {
          ...
          options: [
            { es: "Nos", en: "Us" },
            {
              ...
              en: "The country's economic situation",
            },
      ...
      questions: [
        {
          ...
          options: [
            ...
            {
              es: "Una deliciosa sopa de verduras",
              en: "A delicious vegetable soup",
            },
            {
              es: "Prepara una deliciosa sopa de verduras todos los domingos",
              en: "Prepares a delicious vegetable soup every Sunday",
            },
