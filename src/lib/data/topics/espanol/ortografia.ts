  ...
  lessons: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            { es: "Siempre se escriben sin tilde", en: "They are always written without accent" },
            { es: "\"Aún\" lleva tilde cuando significa \"todavía\" y \"aun\" no la lleva cuando significa \"incluso\"", en: "\"Aún\" has an accent when it means \"still\" and \"aun\" doesn't when it means \"even\"" },
            { es: "Siempre llevan tilde", en: "They always have an accent" },
            { es: "Se escriben igual en todos los contextos", en: "They are written the same in all contexts" },
          ],
          correctAnswer: "1",
          explanation: {
        ...
        },
        {
          ...
          options: [
            { es: "El quiere que le dé más te", en: "He wants you to give him more tea" },
            { es: "Él quiere que le dé más té", en: "He wants you to give him more tea" },
            { es: "El quiere que le de más té", en: "He wants you to give him more tea" },
            { es: "Él quiere que le de mas te", en: "He wants you to give him more tea" },
          ],
          correctAnswer: "1",
          explanation: {
        ...
        },
        {
          ...
          options: [
            { es: "Porque es una palabra aguda", en: "Because it's an oxytone word" },
            { es: "Porque tiene un hiato: la vocal débil (i) tónica junto a una vocal fuerte (a) necesita tilde para romper el diptongo", en: "Because it has a hiatus: the stressed weak vowel (i) next to a strong vowel (a) needs an accent to break the diphthong" },
            { es: "Porque todas las palabras de dos sílabas llevan tilde", en: "Because all two-syllable words have accents" },
            { es: "Es una excepción sin explicación", en: "It's an exception without explanation" },
          ],
          correctAnswer: "1",
          explanation: {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            { es: "Tubo que salir temprano de la oficina", en: "He tube to leave the office early (incorrect)" },
            { es: "Tuvo que salir temprano de la oficina", en: "He had to leave the office early" },
      ...
      questions: [
        {
          ...
          options: [
            { es: "María, compró frutas verduras y pan", en: "Maria, bought fruits vegetables and bread" },
            { es: "María compró frutas, verduras y pan", en: "Maria bought fruits, vegetables and bread" },
            { es: "María compró, frutas verduras y pan", en: "Maria bought, fruits vegetables and bread" },
            { es: "María compró frutas verduras, y pan", en: "Maria bought fruits vegetables, and bread" },
          ],
        ...
        },
        {
          ...
          options: [
            { es: "Los colores primarios son: rojo, azul y amarillo", en: "The primary colors are: red, blue and yellow" },
            { es: "Los colores: primarios son rojo, azul y amarillo", en: "The colors: primary are red, blue and yellow" },
            { es: "Los colores primarios: son rojo, azul y amarillo", en: "The primary colors: are red, blue and yellow" },
            { es: "Los: colores primarios son rojo, azul y amarillo", en: "The: primary colors are red, blue and yellow" },
          ],
          correctAnswer: "0",
        ...
        },
        {
          ...
          options: [
            { es: "El profesor dijo: «Estudien para el examen».", en: "The teacher said: «Study for the exam»." },
            { es: "El profesor dijo «Estudien para el examen.»", en: "The teacher said «Study for the exam.»" },
            { es: "El profesor, dijo: «Estudien para el examen»", en: "The teacher, said: «Study for the exam»" },
            { es: "El profesor dijo, «Estudien para el examen».", en: "The teacher said, «Study for the exam»." },
          ],
